            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4 ">
                <div className="bg-white p-4 rounded-md ">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-yogaGray">
                        <Link className="p-3 rounded-md bg-yogaYellow" href="/"> Teacher's Classes</Link>
                        <Link className="p-3 rounded-md bg-yogaYellow" href="/"> Teacher's Students</Link>
                        <Link className="p-3 rounded-md bg-yogaYellow" href="/"> Teacher's Lessons</Link>
                        <Link className="p-3 rounded-md bg-yogaYellow" href="/"> Teacher's Exams</Link>
                        <Link className="p-3 rounded-md bg-yogaYellow" href="/"> Teacher's Addignments</Link>
                    </div>
                </div>
                <Performance />
                <Announcements />
