...
const renderRow = (item: TeacherList) => (
    <tr key={item.id} className="border-b border-yogaGreen border-opacity-70 even:bg-yogaBlue even:bg-opacity-90 text-sm hover:bg-yogaYellow hover:bg-opacity-1">
        ...
        <td className="hidden md:table-cell">{item.classes.map(clasItem=>clasItem.name).join(", ")}</td>
    ...
    return (
        <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
            ...
            <div className="flex items-center justify-between">
                <h1 className="hidden md:block  backdrop:text-lg font-semibold ">All Teachers</h1>
