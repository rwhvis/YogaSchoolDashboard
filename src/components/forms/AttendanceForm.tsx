...
const schema = z.object({
    username: z
        ...
        .max(20, { message: "Username should be at most 20 characters long" }),
    email: z
        .string()
    ...
    password: z
        ...
        .max(40, { message: "Password should be at most 40 characters long" }),
    firstName: z.string().min(1, { message: "First name is required!" }),
    lastName: z.string().min(1, { message: "Last name is required!" }),
    phone: z.string().min(1, { message: "Phone is required!" }),
    address: z.string().min(1, { message: "Address is required!" }),
    bloodType: z.string().min(1, { message: "Bloodtype is required!" }),
    birthday: z.date({ message: "Birthdate name is required!" }),
...
const AttendanceForm = ({
    ...
    return(
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <span className="text-xs text-yogaGray font-medium">
            ...
            <button className="bg-yogaGreen text-white p-2 rounded-md">
